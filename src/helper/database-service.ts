...
export const insertMany = async (modelName, docs, options = {}) => {
    return modelName.insertMany(docs, options);
}

export const bulkWrite = async (modelName, operations, options = {}) => {
    return modelName.bulkWrite(operations, options);
}
